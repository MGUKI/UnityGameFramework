...
public class ShaderVariantCollector : ScriptableWizard
{
    ...
    static MethodInfo GetShaderVariantEntries = null;         // 获得着色器变体条目   MethodInfo:方法信息
    /// <summary>
    /// 通过反射获取shader的keywords，types，remainingKeywords
    /// </summary>
